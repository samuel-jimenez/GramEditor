...
Tehanu offers an automatic way to create debug scenarios with _debug locators_.
...
Check out all the DAP servers that have already been exposed as extensions [on Tehanu's site](https://tehanu.liten.app/extensions?filter=debug-adapters).
