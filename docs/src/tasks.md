...
- in the global `tasks.json` file; such tasks are available in all Tehanu projects you work on. This file is usually located in `~/.config/tehanu/tasks.json`. You can edit them by using the `zed: open tasks` action.
