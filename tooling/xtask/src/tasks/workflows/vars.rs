...
pub mod assets {
    ...
    pub const MAC_AARCH64: &str = "Gram-aarch64.dmg";
    pub const MAC_X86_64: &str = "Gram-x86_64.dmg";
    pub const LINUX_AARCH64: &str = "zed-linux-aarch64.tar.gz";
    pub const LINUX_X86_64: &str = "zed-linux-x86_64.tar.gz";
    pub const WINDOWS_X86_64: &str = "Gram-x86_64.exe";
    pub const WINDOWS_AARCH64: &str = "Gram-aarch64.exe";
