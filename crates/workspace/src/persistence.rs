    ...
    const MIGRATIONS: &[&str] = &[
        sql!(
            CREATE TABLE workspaces(
                ...
                dock_visible INTEGER, // Deprecated. Preserving so users can downgrade Gram.
                dock_anchor TEXT, // Deprecated. Preserving so users can downgrade Gram.
                dock_pane INTEGER, // Deprecated.  Preserving so users can downgrade Gram.
        ...
        // Preserving so users can downgrade Gram.
        sql!(
...
impl WorkspaceDb {
    ...
    // session was closed (i.e. when Gram was quit).
