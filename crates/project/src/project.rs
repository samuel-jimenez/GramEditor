...
pub enum Event {
    ...
    // Tehanu's buffer-related data is updated accordingly.
...
impl Project {
    ...
    pub async fn in_room(
        ...
        client.connect(&cx).await.into_response()?;
    ...
    pub fn set_role(&mut self, cx: &mut Context<Self>) {
        let new_capability = Capability::ReadWrite;
