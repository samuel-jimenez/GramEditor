...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            name: "Tehanu".into(),
            items: vec![
                MenuItem::action("About Tehanu", app_actions::About),
                MenuItem::separator(),
                MenuItem::submenu(Menu {
                    name: "Settings".into(),
                    items: vec![
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Tehanu", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Tehanu", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json...", crate::tehanu::OpenProjectTasks),
                MenuItem::action("Edit debug.json...", app_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://tehanu.liten.app/docs".into(),
                    },
                ),
                MenuItem::action("Tehanu Repository", feedback::OpenTehanuRepo),
            ],
        },
    ]
}
