...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Tehanu Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Tehanu Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Tehanu Editor Preview Instance Running",
        ReleaseChannel::Stable => "Tehanu Editor Stable Instance Running",
    }
}
